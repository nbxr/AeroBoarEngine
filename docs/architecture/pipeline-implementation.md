...
- Active path: bindless PBR, **GPU frustum** (always) + **optional** same-frame Hi-Z (`occlusionCull`; off by default / off on Adreno). Multi-draw indirect, scene lights + procedural IBL. City/meshlet/Nanite-like: `visibility-lod-plan.md`.
