...
struct SubpassContext {
    ...
    VkPipelineLayout pipeline_layout{VK_NULL_HANDLE}; // often the same as pass->pipeline_layout
    VkPipeline pipeline{VK_NULL_HANDLE};              // optional per‑sub‑pass pipeline
    std::vector<VkDescriptorSet>
        descriptor_sets;        // per‑sub‑pass descriptor sets
    VkCommandPool command_pool{VK_NULL_HANDLE}; // dedicated pool for sub‑pass commands
