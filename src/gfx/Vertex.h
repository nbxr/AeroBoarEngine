...
// Tight, aligned vertex format for mobile VR + GPU-driven rendering (mesh shaders / indirect)
struct Vertex {
...
static_assert(sizeof(Vertex) == Vertex::stride, "Vertex layout must match stride");
